...
export class OrderPickupSchedule {
  ...
  nextSaleEndDateString: string;
  nextSaleEndDate: Date;
  ...
  seller: any;
    ...
    this.nextSaleEndDateString = json.next_sale_end_datetime;
    this.nextSaleEndDate = new Date(json.next_sale_end_datetime);
    ...
    if (json.producer_entity) {
      this.seller = { name: json.producer_entity.name };
    }
	}
}
